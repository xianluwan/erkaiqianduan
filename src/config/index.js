...
export const config  = {
    ...
    API_CONFIG: {
        ...
        staticBaseUrl: [
            'https://usw1.xlw.app/api/v1',
            'https://usw2.xlw.app/api/v1',
            'https://usw3.xlw.app/api/v1',
            'https://usw4.xlw.app/api/v1',
            'https://usw5.xlw.app/api/v1',
            'https://usw6.xlw.app/api/v1'
        ],
    ...
    SITE_CONFIG: {
        ...
        // copyright会自动使用当前年份
        copyright: `© ${new Date().getFullYear()} 仙路湾. All Rights Reserved.`,
    ...
    CLIENT_CONFIG: {
        ...
        clientLinks: {
            ...
            android: 'https://xia.xlw.app/xlw-1.1.3.apk',
            macos: 'https://xia.xlw.app/xlw-1.6.0-macos-universal.dmg',
            windows: 'https://xia.xlw.app/xlw-1.1.3.exe',
    ...
    PROFILE_CONFIG: {
        ...
        showGiftCardRedeem: true, // Xboard 支持礼品卡兑换
    ...
    TICKET_CONFIG: {
        ...
        imgbbApiKey: 'b17f77126e85193fd6ecaa10a7e8da36',
    },

    // 流量明细配置
    TRAFFICLOG_CONFIG: {
        // 是否启用流量明细页面 (true=启用, false=禁用)
        enableTrafficLog: false, // 默认启用

        //是否启用流量明表格 (true=启用, false=禁用）
        showTrafficTable: false, // 默认启用
    ...
    CUSTOMER_SERVICE_CONFIG: {
        ...
        customHtml: '<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="0f267bf9-a61b-48da-870b-b4bac9ed9a9f";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>',
