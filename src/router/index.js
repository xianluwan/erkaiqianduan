...
import { SITE_CONFIG, DEFAULT_CONFIG, isBrowserRestricted, TRAFFICLOG_CONFIG, isXiaoV2board, NAVIGATION_CONFIG } from '@/utils/baseConfig';
...
const Login = () => import('@/views/auth/split/Login.vue');
const Register = () => import('@/views/auth/split/Register.vue');
const ForgotPassword = () => import('@/views/auth/split/ForgotPassword.vue');
