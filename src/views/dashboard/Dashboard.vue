<template>
  <div class="dashboard-container">
    <div class="dashboard-inner">
          ...
          <div class="card-body">
            <div class="subscription-info">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ userStats.remainingTraffic || '0 GB' }}</span>
              </div>
              <div class="info-item">
      ...
      <!-- 订阅导入弹窗 -->
      <transition name="fade">
        <div v-if="showImportCard && userPlan.subscribeUrl" class="import-modal-overlay" @click.self="showImportCard = false">
        <AppCard class="dashboard-card import-card import-modal" hoverable no-padding @click.stop>
          <div class="card-header">
        ...
        <template v-else>
          <AppCard class="stats-card doc-card"
            ...
            <div class="stats-info">
              <div class="stats-value">用户中心</div>
              <div class="stats-label">查看账户资料</div>
            </div>
          ...
          <AppCard class="stats-card doc-card"
            ...
            <div class="stats-info">
              <div class="stats-value">订单列表</div>
              <div class="stats-label">查看我的订单</div>
            </div>
            <div class="chevron-icon">
              <IconChevronRight :size="20"/>
            </div>
          ...
          <AppCard class="stats-card doc-card"
               ...
               style="animation-delay: 0.7s" variant="stats" hoverable no-padding>
            <div class="stats-icon">
          ...
          <AppCard class="stats-card doc-card"
            ...
            <div class="stats-info">
              <div class="stats-value">退出登录</div>
              <div class="stats-label">安全退出当前账户</div>
            </div>
            <div class="chevron-icon">
              <IconChevronRight :size="20"/>
            </div>
