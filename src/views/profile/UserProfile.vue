...
const getDeviceIcon = (ua) => {
  ...
  return deviceType === 'ios' || deviceType === 'android' ? IconDeviceMobile : deviceType === 'unknown' ? IconBrowser : IconDeviceDesktop;
};

const formatDeviceInfo = (ua) => {
  return formatDeviceName(ua, {
    unknownDevice: t('profile.unknownDevice'),
    unknownBrowser: t('profile.unknownBrowser')
  });
};
...
const formatTimestamp = (timestamp) => {
  return formatProfileTimestamp(timestamp);
};
