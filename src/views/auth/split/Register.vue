...
/* 注册表单更紧凑，避免在常见屏幕高度中拉得过长。 */
.register-view-container .auth-form-container {
  padding: 24px 40px;
}

.register-view-container .auth-header {
  margin-bottom: 16px;
}

.register-view-container .auth-logo {
  margin-bottom: 10px;
}

.register-view-container .auth-logo img {
  width: 48px;
  height: 48px;
  min-width: 48px;
  min-height: 48px;
...
.register-view-container .auth-header .auth-subtitle {
  margin-bottom: 0;
}

.register-view-container .auth-form {
  margin-bottom: 8px;
}

.register-view-container .form-group {
  margin-bottom: 12px;
}

.register-view-container .form-control,
.register-view-container .input-with-button,
.register-view-container .btn {
  height: 40px;
}

.register-view-container .agreement-checkbox {
  margin-top: 4px;
}

.register-view-container .auth-footer {
  margin-top: 8px;
  text-align: left;
}

.register-view-container .login-link {
  color: var(--secondary-text-color);
  font-size: 14px;
}

.register-view-container .login-link:hover {
  color: var(--theme-color);
}
