...
/* 收紧标题与表单、登录按钮与注册链接之间的留白。 */
.login-view-container .auth-header {
  margin-bottom: 8px;
}

.login-view-container .auth-subtitle {
  display: none;
}

.login-view-container .auth-form {
  margin-bottom: 8px;
}

.login-view-container .auth-footer {
  margin-top: 8px;
}

.login-view-container .auth-divider {
  margin: 8px 0;
}
</style>
