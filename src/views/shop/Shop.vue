...
.shop-container .shop-inner .plans-wrapper {
  align-items: start;
}

.shop-container .shop-inner .plans-wrapper .plan-card {
  align-self: start;
  container-type: inline-size;
}

.shop-container .shop-inner .plans-wrapper .plan-card .card-body {
  flex: 0 0 auto;
}

.shop-container .shop-inner .plans-wrapper .plan-card .plan-features {
  margin-top: 0;
  margin-bottom: 0;
}

.plan-card :deep(.html-content > div) {
  padding-bottom: 0 !important;
}

.plan-card :deep(.html-content > div > :last-child) {
  margin-bottom: 0 !important;
}

.shop-container .shop-inner .plans-wrapper .plan-card .plan-actions {
  margin: 5px 16px 0;
  gap: 8px;
}

.shop-container .shop-inner .plans-wrapper .plan-card .plan-actions .btn-purchase {
  min-width: 100px;
}
...
@container (min-width: 500px) and (max-width: 560px) {
  .plan-card .plan-actions {
